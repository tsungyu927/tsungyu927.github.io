    ...
    <Wrapper>
      ...
      <div className="relative z-10 w-full min-h sm:min-h-sm pt-40 sm:pt-48 pb-10">
        <div className="px-4 mb-12">
          ...
          <h2 className="w-11/12 sm:w-4/5 mb-6 text-2xl sm:text-4xl font-bold">
            {experience.title}
          </h2>
          <h3
            className="w-full sm:w-4/5 text-muted-foreground"
            dangerouslySetInnerHTML={{
              __html: experience.description.replace(/\n/g, "<br>"),
            }}
          />
        </div>
        <div className="mb-4 flex flex-col sm:border-t">
